...
proc initMultiSignature*(signatures : seq[SingleEd25519Signature], positions : seq[int]) : MultiEd25519Signature =
...
proc initMultiSignature*(signatures : seq[SingleEd25519Signature], bitMap : HexString) : MultiEd25519Signature =
...
proc getSignatures*(signatures : MultiEd25519Signature) : seq[SingleEd25519Signature] = signatures.signatures
...
template deSerializeSingleEd25519Signature(data : var HexString, sig : var SingleEd25519Signature) : untyped =

    let byteLen = deSerializeUleb128(data)
    sig.add data[0..((byteLen * 2) - 1)]
    data = data[(byteLen * 2)..^1]

template deSerializeMultiEd25519Signature(data : var HexString, sigs : var MultiEd25519Signature) : untyped  = 
...
proc deSerialize*[T : SingleEd25519Signature | MultiEd25519Signature](data : var HexString) : T =
